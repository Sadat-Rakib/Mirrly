// Inlined Lucide icon paths (MIT, lucide.dev) + Mirrly's own logo mark.
...
(function () {
  const P = {
    ...
    'pen-line': '<path d="M12 20h9"/><path d="M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.872.837a.5.5 0 0 1-.62-.62l.837-2.872a2 2 0 0 1 .506-.854z"/>',
    ...
    mic: '<path d="M12 19v3"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><rect x="9" y="2" width="6" height="12" rx="3"/>',
    ...
    cat: '<path d="M12 5c.67 0 1.35.09 2 .26 1.78-2 5.03-2.84 6.42-2.26 1.4.58-.42 7-.42 7 .57 1.07 1 2.24 1 3.44C21 17.9 16.97 21 12 21s-9-3.1-9-7.56c0-1.2.43-2.37 1-3.44 0 0-1.82-6.42-.42-7 1.39-.58 4.64.25 6.42 2.26A9.04 9.04 0 0 1 12 5Z"/><path d="M8 14v.5"/><path d="M16 14v.5"/><path d="M11.25 16.25h1.5L12 17l-.75-.75Z"/>',
  ...
  // Mirrly logo — an iridescent glass tile holding an "M" ribbon over its own
  // reflection arc (M + mirror = Mirrly). Original mark, no external assets.
  const LOGO = '<svg viewBox="0 0 48 48" width="SIZE" height="SIZE" fill="none" xmlns="http://www.w3.org/2000/svg">' +
    '<defs>' +
    '<linearGradient id="mirrly-g1" x1="4" y1="4" x2="44" y2="44" gradientUnits="userSpaceOnUse">' +
    '<stop offset="0" stop-color="#8B5CF6"/><stop offset="0.52" stop-color="#3C83F5"/><stop offset="1" stop-color="#22D3EE"/>' +
    '</linearGradient>' +
    '<linearGradient id="mirrly-g2" x1="24" y1="2" x2="24" y2="22" gradientUnits="userSpaceOnUse">' +
    '<stop offset="0" stop-color="#FFFFFF" stop-opacity="0.65"/><stop offset="1" stop-color="#FFFFFF" stop-opacity="0"/>' +
    '</linearGradient>' +
    '</defs>' +
    '<rect x="2" y="2" width="44" height="44" rx="13" fill="url(#mirrly-g1)"/>' +
    '<rect x="3" y="3" width="42" height="42" rx="12.2" fill="none" stroke="url(#mirrly-g2)" stroke-width="1.6"/>' +
    '<path d="M14 30.5V19.8c0-1.05 1.27-1.57 2-.83l7.15 7.32a1.2 1.2 0 0 0 1.7 0L32 18.97c.73-.74 2-.22 2 .83V30.5" stroke="#FFFFFF" stroke-width="3.3" stroke-linecap="round" stroke-linejoin="round"/>' +
    '<path d="M15 35.6c2.7 1.6 5.8 2.5 9 2.5s6.3-.9 9-2.5" stroke="#FFFFFF" stroke-opacity="0.5" stroke-width="2.4" stroke-linecap="round"/>' +
    '</svg>';
